...
import com.sagirov.ilovedog.presentation.MainActivity.Companion.myPetPaddockT
import com.sagirov.ilovedog.R
import com.sagirov.ilovedog.domain.utils.ServicesAndReceivers.TimerService
import com.sagirov.ilovedog.domain.utils.PreferencesUtils
import com.sagirov.ilovedog.domain.utils.theme.circularColor
                ...
                OutlinedButton(
                    onClick = {
                        if (!isStartTimer) {
                            ...
                            circularColor.value =
                                com.sagirov.ilovedog.domain.utils.theme.circularColor

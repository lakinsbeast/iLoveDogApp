...
class VaccinationActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        dogsViewModel.getAllVaccinations.observe(this) {
        ...
        setContent {
            ...
            Scaffold(topBar = {}, floatingActionButton = {
                FloatingActionButton(onClick = { startActivity(Intent(this@VaccinationActivity,NewVaccineActivity::class.java))}, content = {
                    Icon(
                        Icons.Filled.Add,
                        contentDescription = ""
                    )
                ...
                if (dialogDeleteVaccine.value) {
                    AlertDialog(onDismissRequest = {dialogDeleteVaccine.value = false}, buttons = {
                        Column() {
                            OutlinedButton(
                                onClick = {
                                    dogsViewModel.deleteVaccination(idOfColumn)
                                    idOfColumn = 0
